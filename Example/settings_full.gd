...
# Leave buttons
@onready var b_leave_settings: Button = %B_leave_settings
@onready var b_leave_lang: Button = %B_leave_lang

# Panels 
@onready var settings: PanelContainer = %settings
@onready var lang: PanelContainer = %lang
...
func _ready() -> void:
	...
	# Settings Buttons
	b_lang.pressed.connect(enter_lang)
	
	# Buttons
	b_leave_settings.pressed.connect(leave_settings)
	b_leave_lang.pressed.connect(leave_lang)
...
# Panels ------------------
func enter_lang() -> void:
	settings.hide()
	lang.show()
	
func leave_lang() -> void:
	settings.show()
	lang.hide()
